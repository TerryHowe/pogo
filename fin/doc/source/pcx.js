...
rsiDom=rsiDom.replace(/.*(\.[\w\-]{4,}\.[a-zA-Z]{2}$)/,'$1');
document.cookie="rsi_csl="+rsicsl+";expires="+rsiExp.toGMTString()+";path=/;domain="+rsiDom;
var rsiSegs="";
var rsiPat=/.*_5.*/;
...
if(typeof(DM_onSegsAvailable)=="function"){DM_onSegsAvailable(['G07608_10001'],'g07608');}
